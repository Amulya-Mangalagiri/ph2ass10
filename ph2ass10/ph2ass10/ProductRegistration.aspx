<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRegistration.aspx.cs" Inherits="ph2ass10.ProductRegistration" %>
        ...
        <div>
            ...
            <table class="auto-style1">
                <tr>
                    <td>Product Image</td>
                    <td>
                                     <div class="col-md-4"><asp:Image runat="server" ID="Image3" ImageUrl="~/ProductImages/HeadPhones.jpeg" Width="500" Height="500" CssClass="img-fluid" /></div>
                        </td>
